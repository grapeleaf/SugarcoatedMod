...
1.  **Install Prerequisites:**
    *   **JDK 17 or higher:** This is essential for compiling the sugarcoated and your mod. Checked by `settings.gradle`.
...
4.  **Configure Your Mod:**
    ...
    This sugarcoated is designed to make initial setup straightforward. You'll primarily need to modify the following:
    ...
    *   **Java Source Files:**
        ...
        * Refactor package names within the `annotations` and `tools` modules similarly (e.g., `sugarcoated` to `annotations/src/myawesomemod/annotations/...`).
    ...
    -    "main": "sugarcoated.SugarcoatedMod",
...
This sugarcoated compiles everything to Java 17 bytecode (the `main` module sets `sourceCompatibility`, `targetCompatibility`, and `options.release` to 17), so the built JAR requires a Java 17 runtime. All modules in this sugarcoated are standardized to use Java 17.
...
List of planned features and improvements for the sugarcoated itself.
...
This mod sugarcoated is provided as a starting point and does not impose a specific license on your derivative work. You are free to choose the license for your mod.
